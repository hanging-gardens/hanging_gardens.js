...
exports.info = function(package, options, callback){
  ...
  , narrow_queue:   []
  , registry:       {}
  , local_registry: options.local_registry
  };
...
if (module === require.main) {
  ...
  registry = "/Users/Simon/Projects/hanging_gardens.js/examples";
  options  = { local_registry: registry };
  
  exports.info(package, options, function(err, packages){
    if(err) throw err;
